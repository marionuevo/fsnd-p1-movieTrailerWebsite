...
<head>
    ...
    <title>marioNuevo Favorite Movies</title>
    ...
    <style type="text/css" media="screen">
        body {
            ...
            background-image: radial-gradient(circle 600px at 50% , #fff 0%, #aaa 100%);
        }
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">marioNuevo Favorite Movies</a>
          </div>
        </div>
      </div>
    </div>
